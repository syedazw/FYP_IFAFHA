...
import MedicineForm from "../../Form/addMedicine"
    ...
    return (
        <>
                    ...
                    <nav className="navbar">
                            ...
                            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item"><Link to={`/patientprofile/medication/${params.PatientID}`} className="nav-link text-primary mx-3" >MEDICATIONS</Link></li>
            ...
            <div className="container-fluid" style={{ backgroundColor: "white" }}>
                <div className="row">
                    <h4 className="fw-bold text-center">MEDICATION</h4>
                </div>
            </div>
